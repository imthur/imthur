...
<p align="center">
  <a href="./README.en.md"><img src="https://img.shields.io/badge/Read%20in%20English-1E1E1E?style=for-the-badge&logo=googletranslate&logoColor=white" /></a>
...
## O que estou puxando agora

- construir APIs e sistemas web com regras de negócio mais próximas do mundo real;
- melhorar arquitetura, permissões, autenticação, validações e testes;
- trabalhar melhor deploy, CI, logs, observabilidade e rotinas operacionais;
- evoluir como dev back-end sem abandonar a noção de produto, interface e experiência.

---

## Stack que aparece bastante nos meus projetos
...
```txt
problema real -> regra clara -> dados bem modelados -> API organizada -> interface útil -> deploy que aguenta o básico
```

Gosto de software com cara de coisa que alguém usaria. Não precisa ser gigante, mas precisa ter intenção.
